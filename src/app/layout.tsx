...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      >
        <main className="mx-auto max-w-6xl px-0 py-0">{children}</main>
        <footer className="mx-auto max-w-6xl px-4 py-6 text-sm text-zinc-600 dark:text-zinc-400 sm:px-6 sm:py-10">
